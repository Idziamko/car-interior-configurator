...
export const CAMERA_ANGLES: CameraAngle[] = [
  ...
  {
    id: "cabin_overview",
    nameRu: "Обзор кабины (из-за подголовников)",
    icon: "🎬",
    prompt: "Wide-angle symmetric 'cockpit overview' shot. Camera positioned behind the front-seat headrests on the cabin centerline (in a 4-door car: centered between the rear headrests; in a 2-seat coupe/roadster: just behind the front headrests against the rear bulkhead), slightly above headrest height, pointing straight forward through the cabin toward the windshield. Ultra-wide field of view — fills the frame edge-to-edge. Visible in the foreground: tops of both front seat backrests and headrests on the left and right edges, with seat stitching/quilting clearly readable. Center frame: the entire dashboard spanning the full width — full instrument cluster (analog or digital gauges clearly visible), central infotainment display showing a navigation/media UI, A/C vents, climate controls on the center stack. Steering wheel centered in the lower-middle of the frame with OEM badge clearly visible. Center console and tunnel with shift knob/boot, cupholders, drive-mode buttons. Both door cards on the far edges with armrests and handles. Windshield occupies the upper third showing a softly blurred road / tree-lined environment ahead (subtle bokeh, not a studio). Interior rearview mirror at the very top edge of the frame. Natural daylight from ahead, sharp focus across the dashboard and front seats, slightly compressed perspective like a shot from a symmetrical dash-cam but wider and more cinematic. No occupants visible."
  },
  {
    id: "front_to_rear",
